...
Or download the latest release, v0.0.3, directly:

- Apple silicon (arm64): [signed `.pkg`](https://github.com/ClarifiedLabs/mdcli/releases/download/v0.0.3/md_v0.0.3_darwin_arm64.pkg) · [`.tar.gz`](https://github.com/ClarifiedLabs/mdcli/releases/download/v0.0.3/md_v0.0.3_darwin_arm64.tar.gz)
- Intel (amd64): [`.tar.gz`](https://github.com/ClarifiedLabs/mdcli/releases/download/v0.0.3/md_v0.0.3_darwin_amd64.tar.gz)

### Linux

v0.0.3 is available for amd64/x86_64 and arm64/aarch64:

| Format | amd64 / x86_64 | arm64 / aarch64 |
|---|---|---|
| Package | [`.deb`](https://github.com/ClarifiedLabs/mdcli/releases/download/v0.0.3/md_0.0.3_amd64.deb) · [`.rpm`](https://github.com/ClarifiedLabs/mdcli/releases/download/v0.0.3/md-0.0.3-1.x86_64.rpm) | [`.deb`](https://github.com/ClarifiedLabs/mdcli/releases/download/v0.0.3/md_0.0.3_arm64.deb) · [`.rpm`](https://github.com/ClarifiedLabs/mdcli/releases/download/v0.0.3/md-0.0.3-1.aarch64.rpm) |
| Tarball | [`.tar.gz`](https://github.com/ClarifiedLabs/mdcli/releases/download/v0.0.3/md_v0.0.3_linux_amd64.tar.gz) | [`.tar.gz`](https://github.com/ClarifiedLabs/mdcli/releases/download/v0.0.3/md_v0.0.3_linux_arm64.tar.gz) |

Every asset is listed with its SHA-256 in
[`checksums.txt`](https://github.com/ClarifiedLabs/mdcli/releases/download/v0.0.3/checksums.txt).
